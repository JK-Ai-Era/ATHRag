...
```bash
# 启动
launchctl load ~/Library/LaunchAgents/com.ATHRag.embedding-worker.plist

# 停止
launchctl unload ~/Library/LaunchAgents/com.ATHRag.embedding-worker.plist
...
└── com.ATHRag.embedding-worker.plist  # LaunchAgent 配置
```
