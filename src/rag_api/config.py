...
class Settings(BaseSettings):
    ...
    OLLAMA_COMPRESS_MODEL: str = "qwen3.5:4b"
    ...
    # 查询变换配置
    QUERY_TRANSFORM_ENABLED: bool = False  # 是否默认启用查询变换
    QUERY_TRANSFORM_MODE: str = "multi_query"  # 默认变换模式
    QUERY_TRANSFORM_NUM_VARIANTS: int = 3  # 扩展变体数量
    
    # 上下文压缩配置
    CONTEXT_COMPRESS_ENABLED: bool = False  # 是否默认启用上下文压缩
