...
def list_projects(
    ...
    console.print("[dim]      ath search <项目名> <查询内容>[/dim]")
    console.print("[dim]      ath search --full 显示完整ID[/dim]")
...
def clean_orphan_projects(
    ...
    用法：
      ath project clean-orphan           # 检查并清理孤儿项目
      ath project clean-orphan --dry-run # 只显示，不实际删除
    """
